import { SET_ACCEPT_ONHOLD_REQUEST, SET_CLERK_LIST, SET_LIBRARIAN_LIST, SET_PERSON_DETAILS, SET_PERSON_ID, SET_PERSON_LOAN_REQUESTS, SET_PERSON_ONHOLD_REQUESTS } from "./manage-actions";
