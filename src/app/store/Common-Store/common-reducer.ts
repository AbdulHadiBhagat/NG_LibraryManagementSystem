...
import { SET_TABLE_ID,SET_ALL_BOOKS, SET_BOOK_GRID_DATA, SET_LOAN_CONTENT, SET_PERSON, SET_PERSON_GRID_DATA, SET_CONTENT, SET_SHOW_PERSON_POPUP, SET_SHOW_BOOK_POPUP, SET_SHOW_ALL_BOOKS, SET_SHOW_ALL_HISTORY, SET_BOOK_DETAIL_ID, SET_ON_HOLD_ID, SET_PERSON_DETAIL_ID } from './common.actions';
